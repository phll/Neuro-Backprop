...
\begin{figure*}[!ht]
  \centering
  \subfigure[Draft of a biological pyramidial neuron.]{\includegraphics[height=0.3\linewidth]{img/pyramidial.png}}\quad
  \subfigure[Abstracted and simplified computational model of a pyramidial neuron.]{\includegraphics[height=0.32\linewidth]{img/pyr_abstract.png}}\quad
  ...
  \caption{Different neuron types.}
  \label{fig:neurons}
\end{figure*}
